  ...
  return (
    <div className="p-8 max-w-3xl mx-auto space-y-8">
      ...
      <div>
        ...
        <p className="text-zinc-500 mt-1">Manage your identity, competencies, and capacity settings.</p>
      </div>
      ...
      <div className="bg-white rounded-3xl border border-zinc-100 shadow-sm overflow-hidden">
        ...
        <div className="h-24 bg-zinc-900 relative">
          <div className="absolute bottom-0 translate-y-1/2 left-8">
            <div className="h-20 w-20 rounded-3xl bg-white border-4 border-white shadow-xl flex items-center justify-center text-2xl font-black text-zinc-900 shadow-zinc-200">
        ...
        <div className="pt-14 px-8 pb-8 space-y-8">
          ...
          <div className="flex items-center gap-3">
            <span className={cn('px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest', roleConfig[role].color)}>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-3 px-4 py-3 bg-zinc-50 rounded-2xl border border-zinc-100 text-sm text-zinc-500 font-medium">
            ...
            {/* Full Name */}
            <div className="space-y-2">
              <Label htmlFor="fullName" className="text-[10px] uppercase font-black tracking-widest text-zinc-400">
                Display Name
              </Label>
              <Input
                id="fullName"
                ...
                className="rounded-2xl border-zinc-200 h-12 font-medium"
              />
            </div>
            ...
            <div className="space-y-3">
              ...
              />
              <div className="flex justify-between text-[9px] text-zinc-300 font-medium uppercase tracking-wider">
                <span>8h min</span>
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  className="rounded-2xl border-zinc-200 flex-1 font-medium"
                />
                <Button
                  variant="outline"
                  size="icon"
                  ...
                  className="rounded-2xl border-zinc-200 h-10 w-10"
                >
                  <Plus size={15} />
                </Button>
              </div>
              ...
              <div className="flex flex-wrap gap-2 min-h-8">
                {skills.length === 0 ? (
                  <p className="text-xs text-zinc-300 italic">No skills added yet.</p>
                ) : skills.map(skill => (
                  <Badge
                    key={skill}
                    variant="secondary"
                    className="pl-3 pr-1.5 py-1 flex items-center gap-1.5 rounded-xl bg-zinc-100 text-zinc-700 border-none font-medium"
                  >
                    {skill}
                    <button
              ...
              {/* Skill fill indicator */}
              <div className="space-y-1">
                <div className="flex justify-between text-[9px] font-medium text-zinc-400 uppercase tracking-wider">
                  <span>Skill Profile Completeness</span>
          ...
          <div className="flex items-center gap-4 pt-2">
            <Button
              onClick={handleSave}
              disabled={saving}
              className="bg-zinc-900 text-white font-bold px-8 rounded-2xl shadow-xl shadow-zinc-900/20 hover:bg-zinc-800"
            >
