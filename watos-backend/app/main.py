...
app.include_router(monthly_reports.router, prefix="/api/v1/monthly-reports", tags=["Monthly Reports"])
...
async def startup_event():
    ...
    from app.models import (  # noqa
        ...
        complexity_anchor, webhook, rebalance_proposal, push_subscription,
        report
    )
